"""
Django settings for health_plus project.
...
SECRET_KEY = 'django-insecure-&ywkrsn=)32sz-p3((b(=w!*$ry6lao%$fq21m=d&^1u8#)axq'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'backend.apps.cart.views.CartPageView',
...
SESSION_COOKIE_AGE = 160704000 # 1 Месяц